...
public class GetPatientEncounter {

	
	

	  public JSONObject getPatientEcounter(String identifierPatient) {
		  ...
		  jsonresp=new GetPatientEncounter().getEncounter(patient_Uuid);
  ...
  public JSONObject getEncounter(String uuid) {
		  
		  
		  JSONObject jsondata=new JSONObject();
		  	
			
			  String https_url = "https://"+PersonApi.IP+"/openmrs/ws/rest/v1/encounter?patient="+uuid+"&v=full";
