...
public class PatientSaveDrugs {
	...
	public JSONObject   addDrugDetails(String DrugsName,String strength) {
	
		JSONObject jsondata=new JSONObject();
		//String DrugsName="Paracetamol & Codeine Phosphate 500mg + 10mg";
		JSONObject data=new PatientSaveDrugs().getDrugUuid(DrugsName);
	...
	public JSONObject  addDrugs(String DrugName,String dose,String frequency,String quantity,String duration,String durationUnits,String strength ,String patientIdentifier){
		...
		String doseUnit="";
	        ...
	        JSONObject data=new PatientSaveDrugs().addDrugDetails(DrugName,strength);
	       ...
	       if(drug_form.equalsIgnoreCase("Tablet"))
	              doseUnit="Tablet(s)";
	       else  if(drug_form.equalsIgnoreCase("Capsule"))
	    	   doseUnit="Capsule(s)";
	       else  if(drug_form.equalsIgnoreCase("ml")  || drug_form.equalsIgnoreCase("Syrup")  || drug_form.equalsIgnoreCase("Injection"))
	    	   doseUnit="ml";
	       else  if(drug_form.equalsIgnoreCase("mg"))
	    	   doseUnit="mg";
	       else  if(drug_form.equalsIgnoreCase("IU"))
	    	   doseUnit="IU";
	       else  if(drug_form.equalsIgnoreCase("Drop"))
	    	   doseUnit="Drop";
	       else  if(drug_form.equalsIgnoreCase("Tablespoon"))
	    	   doseUnit="Tablespoon";
	       else  if(drug_form.equalsIgnoreCase("Teaspoon"))
	    	   doseUnit="Teaspoon";
	       else  if(drug_form.equalsIgnoreCase("Unit"))
	    	   doseUnit="Unit(s)";
	       else  if(drug_form.equalsIgnoreCase("Puff"))
	    	   doseUnit="Puff(s)";
	       ...
	       if(durationUnits.equalsIgnoreCase("day"))
	    	   durationUnits="Day(s)";
	       else  if(durationUnits.equalsIgnoreCase("week"))
	    	   durationUnits="Week(s)";
	       else  if(durationUnits.equalsIgnoreCase("month"))
	...
	//get Drugs UUId via Rest api
      ...
      public JSONObject getDrugUuid(String DrugName) {
