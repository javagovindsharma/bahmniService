...
public class PatientSaveBateriology {
	...
	public JSONObject   addBateriologyDetails(String DrugsName,String strength) {
	
		JSONObject jsondata=new JSONObject();
		JSONObject data=new PatientSaveBateriology().getBateriologyUuid(DrugsName);
	...
	public JSONObject  addBateriology(String DrugName,String dose,String frequency,String quantity,String duration,String durationUnits,String strength ,String patientIdentifier){
		...
		String doseUnit="";
	        ...
	        JSONObject data=new PatientSaveBateriology().addBateriologyDetails(DrugName,strength);
	...
	//get Drugs UUId via Rest api
      ...
      public JSONObject getBateriologyUuid(String DrugName) {
