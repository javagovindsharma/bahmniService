...
public class PatientSaveDisposition {

	String httpURL="https://13.232.102.174/openmrs/ws/rest/v1/bahmnicore/bahmniencounter";
	 
	
	public JSONObject  addDisposition(String comments,String patientIdentifier){
	
		JSONObject jsondata=new JSONObject();
		   
	       comments="Govind Sharma Comments";
	       
	       //Here get PatientUUId by Indetifier
	       String patientUuuid=new Commontrust().getPatientUuid(patientIdentifier);
	       
	       
	    String dispositionStr="{\"additionalObs\":[{\"concept\":"
	    		+ "{\"uuid\":\"81cded5a-3f10-11e4-adec-0800271c1b75\"},"
	    		+ "\"value\":\""+comments+"\",\"voided\":false}],\"dispositionDateTime\":null,"
	    		+ "\"code\":\"ADMIT\",\"conceptName\":\"Admit Patient\"}";
