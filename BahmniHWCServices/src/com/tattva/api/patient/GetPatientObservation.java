...
public class GetPatientObservation {

	
	
	
	
	  public JSONObject getPatientObs(String identifierPatient) {
		  ...
		  jsonresp=new GetPatientObservation().getObservation(patient_Uuid);
	  ...
	  public JSONObject getObservation(String uuid) {
		  
		  
		  JSONObject jsondata=new JSONObject();
		  	
			
			  String https_url = "https://"+PersonApi.IP+"/openmrs/ws/rest/v1/obs?patient="+uuid+"&v=full";
