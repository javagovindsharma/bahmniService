...
public class PatientSaveConsultant {
	...
	public JSONObject   addConsultantDetails(String DrugsName,String strength) {
	
		JSONObject jsondata=new JSONObject();
		JSONObject data=new PatientSaveConsultant().getDrugUuid(DrugsName);
	...
	public JSONObject  addConsultant(String DrugName,String dose,String frequency,String quantity,String duration,String durationUnits,String strength ,String patientIdentifier){
		...
		String doseUnit="";
	        ...
	        JSONObject data=new PatientSaveConsultant().addConsultantDetails(DrugName,strength);
