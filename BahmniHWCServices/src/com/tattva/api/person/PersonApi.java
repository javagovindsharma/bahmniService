...
public class PersonApi {
	...
	public static String IP="13.232.102.174";    //"180.179.206.169";
	
	
	

	public JSONObject testIt(String name) {
		
		JSONObject jsondata=null;
		String https_url = "https://"+IP+"/openmrs/ws/rest/v1/person?q="+name+"&v=full&limit=900&startIndex=0";
