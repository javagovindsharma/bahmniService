...
public class getPersonDataByUUID {
	
	

	public JSONObject testIt(String uuid) {
		
		JSONObject jsondata=null;
		String https_url ="https://"+PersonApi.IP+"/openmrs/ws/rest/v1/person/"+uuid+"?v=full"; 

		System.out.println("getperson url"+https_url);
